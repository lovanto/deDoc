...
class Blog extends Component {
    render() {
        return (
            <article className="awdaw" style={{ minHeight: '100%', marginLeft: '30px', background: '#ffffff' }}>
                <div className="row" style={{ marginRight: '0' }}>
                    <div className="dwsefgdwsefg animate__animated animate__fadeIn" id="contactArea">
                        <div className="d-flex justify-content-start adawd" style={{ border: '1px solid #ebebeb', borderBottom: '0px solid #ebebeb' }}>
                            <Link to="chat" id="backbtnChat" className="p-4" style={{ backgroundColor: '#F8F8F8' }}> <img src="../src/img/icons/back.svg" alt="" /> </Link>
                        ...
                        <div className="adwadadwdwdawd" style={{ overflowY: 'scroll', border: '1px solid #ebebeb', minHeight: '94%', maxHeight: '94%' }}>
                    ...
                    <div className="col-md-9 oihugyf animate__animated animate__fadeIn" id="chatArea" style={{ marginLeft: '-33px', zIndex: '100' }}>
                        ...
                        <div className="chat-area" id="chatNow2" style={{ border: '1px solid #ebebeb', minHeight: '78%', maxHeight: '78%', zIndex: '100', background: 'white' }}>
